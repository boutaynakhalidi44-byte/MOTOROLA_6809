 ...
 * Stores a 16-bit value from X into memory
 */
public class STXInstruction implements Instruction {
    ...
    public STXInstruction(String mnemonic, int mode) {
    ...
    public void execute(CPU cpu, Memory memory) {
        ...
        cpu.setFlag(CPU.CC_N, (x & 0x8000) != 0);
        cpu.setFlag(CPU.CC_Z, x == 0);
