...
/**
 * LDS - Load S register (16-bit)
 * Loads a 16-bit value into the S register
 */
public class LDSInstruction implements Instruction {
    ...
    public LDSInstruction(String mnemonic, int mode) {
    ...
    public int getSize() {
        switch(mode) {
            ...
            case EXTENDED_INDIRECT:
                return 5;  // 0x04 0x10 0xBF 0x00 0x09
            default:
                return 0;
        }
    }
