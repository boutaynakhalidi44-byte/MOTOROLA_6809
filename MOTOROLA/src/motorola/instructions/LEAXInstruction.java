...
/**
 * LEAX - Load Effective Address X
 * Loads the effective address (not the value at that address) into X
 */
public class LEAXInstruction implements Instruction {
    ...
    public LEAXInstruction(String mnemonic, int mode) {
    ...
    public void execute(CPU cpu, Memory memory) {
        ...
        // Load effective address into X (not the value at that address)
        cpu.setRegX(address & 0xFFFF);
