...
/**
 * LEAS - Load Effective Address S
 * Loads the effective address (not the value at that address) into S
 */
public class LEASInstruction implements Instruction {
    ...
    public LEASInstruction(String mnemonic, int mode) {
    ...
    public void execute(CPU cpu, Memory memory) {
        ...
        // Load effective address into S (not the value at that address)
        cpu.setRegS(address & 0xFFFF);
