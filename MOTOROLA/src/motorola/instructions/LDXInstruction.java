 ...
 * Loads a 16-bit value into the X register
 */
public class LDXInstruction implements Instruction {
    ...
    public LDXInstruction(String mnemonic, int mode) {
