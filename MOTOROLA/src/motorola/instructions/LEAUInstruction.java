...
/**
 * LEAU - Load Effective Address U
 * Loads the effective address (not the value at that address) into U
 */
public class LEAUInstruction implements Instruction {
    ...
    public LEAUInstruction(String mnemonic, int mode) {
    ...
    public void execute(CPU cpu, Memory memory) {
        ...
        // Load effective address into U (not the value at that address)
        cpu.setRegU(address & 0xFFFF);
