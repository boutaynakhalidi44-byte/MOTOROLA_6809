...
/**
 * LDD - Load 16-bit value into D (A:B accumulator pair)
 */
public class LDDInstruction implements Instruction {
    ...
    public LDDInstruction(String mnemonic, int mode) {
