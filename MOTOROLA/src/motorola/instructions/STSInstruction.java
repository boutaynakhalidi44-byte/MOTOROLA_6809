...
/**
 * STS - Store S register (16-bit)
 * Stores a 16-bit value from S into memory
 */
public class STSInstruction implements Instruction {
    ...
    public STSInstruction(String mnemonic, int mode) {
    ...
    public void execute(CPU cpu, Memory memory) {
        ...
        memory.writeWord(address, s);

        cpu.setFlag(CPU.CC_N, (s & 0x8000) != 0);
        cpu.setFlag(CPU.CC_Z, s == 0);
