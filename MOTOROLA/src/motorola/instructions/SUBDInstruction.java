...
/**
 * SUBD - Subtract 16-bit value from D (A:B accumulator pair)
 * D = D - operand
 */
public class SUBDInstruction implements Instruction {
    ...
    public SUBDInstruction(String mnemonic, int mode) {
